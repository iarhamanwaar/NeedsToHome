...
class ProductList extends StatefulWidget {
  int shopId;
  String shopType;
  ProductList({Key key, this.shopId, this.shopType}) : super(key: key);
  @override
...
class _ProductListState extends StateMVC<ProductList>
  ...
  void initState() {
    super.initState();
    print('shop Id${widget.shopType}');
    _con.listenForProductsByCategory(widget.shopType=='2'?'Itemproduct':'product', widget.shopId);
  ...
  tabMaker() {
    ...
    _con.categoryProducts.forEach((element) {
      tabs.add(Tab(
  ...
  Widget build(BuildContext context) {
    ...
    return _con.categoryProducts.isEmpty
        ? EmptyOrdersWidget()
        : DefaultTabController(
            length: _con.categoryProducts.length,
            child: Padding(
                          ...
                          children: [
                            Div(
                                ...
                                child: Wrap(children: [
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      int row =  _con.categoryProducts.length;
                                  ...
                                  Container(
                                    ...
                                    child: IconButton(
                                      ...
                                      onPressed: () {
                                       ...
                                       widget.shopType=='2'?    Navigator.of(context).push(MaterialPageRoute(builder: (context) => AddItem(shopId: widget.shopId,)))

                                           : Navigator.of(context).push(MaterialPageRoute(builder: (context) => AddProduct(shopId: widget.shopId,)));
                                      },
                                    ),
                                  )
                                ])),
                                  ...
                                  children:[
                                    ...
                                    Padding(
                                      ...
                                      child:IconButton(
                                        onPressed:(){
                                          setState(() {
                                            _con.listenForProductsByCategory('product', widget.shopId);
                                          });
                  ...
                  Expanded(
                    child: TabBarView(
                      ...
                      children: List.generate(
                        _con.categoryProducts.length,
                        (index) {
                          Product _productDetails =
                              _con.categoryProducts.elementAt(index);

                          return ProductTabs(
                            productDetails: _productDetails.productdetails,
                            con: _con,
                            pageType: widget.shopType=='2'?'Itemproduct':'product',
                            callback: this.callback,
