...
class SearchBoxOredr extends StatefulWidget {
  SearchBoxOredr({this.searchType,this.userList, Key key}) : super(key: key);
  String searchType;
  List<UserModel> userList;
  @override
  _SearchBoxOredrState createState() => _SearchBoxOredrState();
}

class _SearchBoxOredrState extends StateMVC<SearchBoxOredr> {
  bool isSwitched = false;
  List<UserModel> itemList;
  bool status = false;
  SearchController _con;
  _SearchBoxOredrState() : super(SearchController()) {
    _con = controller;
  }
