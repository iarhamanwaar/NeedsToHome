...
class _SlipState extends State<Slip> {
  ...
  Future<Uint8List> _generatePdf(PdfPageFormat format, String date,time) async {
              ...
              children: [
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text(setting.value.appName,style: pw.TextStyle(fontWeight:pw.FontWeight.bold,fontSize: 10),),

                    pw.SizedBox(height:10),
                    pw.Text(widget.con.addressShop.addressSelect,style: pw.TextStyle(fontWeight:pw.FontWeight.bold,fontSize:7)),
                    pw.SizedBox(height:5),
                    pw.Text(widget.con.addressShop.phone,style: pw.TextStyle(fontSize:7)),
                  ],
                ),
                pw.SizedBox(height:10),
                /**  pw.Container(
                    ...
                    pw.Container(
                      child:pw.Column(
                        ...
                        children: [
                          ...
                          pw.SizedBox(height: 4),
                          pw.Text(Helper.pricePrint(widget.con.payment.delivery_fees)),
                          pw.SizedBox(height:4),
                          pw.Text(Helper.pricePrint(widget.con.payment.delivery_tips)),
                          pw.SizedBox(height:4),
                          pw.Text(Helper.pricePrint(widget.con.payment.tax)),
                          pw.SizedBox(height:10),
                          pw.Text(Helper.pricePrint(widget.con.payment.grand_total),style: pw.TextStyle(fontWeight:pw.FontWeight.bold)),
