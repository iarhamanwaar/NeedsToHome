...
import '../models/addon2.dart';
import 'AddonViewWidget.dart';
...
class _InvoiceWidgetState extends StateMVC<InvoiceWidget> {
                                                ...
                                                Wrap(
                                                    children:[
                                                      ...
                                                      Container(
                                                        ...
                                                        child:map.addon.length>0?Text('${map.variantValue} ${map.unit}'):Text('${map.quantity} ${map.unit}',
                                                        ),),
                                                      map.addon.length>0?IconButton(
                                                        onPressed: (){

                                                          addonView(map.addon, map.qty.toString());
                                                        },
                                                                    ...
                                                                    child: Wrap(
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:  Text(Helper.pricePrint(_con.invoiceDetailsData.payment.sub_total),
                                                              ...
                                                              child: Wrap(
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:  Text(Helper.pricePrint(_con.invoiceDetailsData.payment.delivery_fees),
                                                              ...
                                                              child: Wrap(
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:    Text(Helper.pricePrint(_con.invoiceDetailsData.payment.delivery_tips),
                                                              ...
                                                              child: Wrap(
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: Text(Helper.pricePrint(_con.invoiceDetailsData.payment.tax),
                                                              ...
                                                              child: Wrap(
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: Text(Helper.pricePrint(_con.invoiceDetailsData.payment.grand_total),
  ...
  void addonView(List<Addon2Model> addon, qty) {
                  ...
                  children: <Widget>[
                    ...
                    Column(
                        children: List.generate(addon.length, (index) {
                          return AddonViewWidget(addonData: addon[index],qty: qty,);
                        })),
                  ],
                ),
              ),
