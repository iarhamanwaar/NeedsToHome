          ...
          child: _con.loaderData? Column(
            ...
            children: <Widget>[
              ...
              Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children:[
                    Text('Driver Name',style:Theme.of(context).textTheme.subtitle1),
                    Container(
                        width:size.width > 670 ? size.width * 0.2: 140,
                        alignment: Alignment.topRight,
              ...
              Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children:[
                    Text(S.of(context).status,style:Theme.of(context).textTheme.subtitle1),
                    Container(
                        width:size.width > 670 ? size.width * 0.2: 140,
                        alignment: Alignment.topRight,
              ...
              Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children:[
                    Text(S.of(context).date,style:Theme.of(context).textTheme.subtitle1),
                    Container(
                        width:size.width > 670 ? size.width * 0.2: 140,
                        alignment: Alignment.topRight,
