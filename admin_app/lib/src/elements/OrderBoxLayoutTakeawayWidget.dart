...
class OrderBoxLayoutTakeawayWidget extends StatefulWidget {
  String tabTab;
  OrderController con;
  OrderBoxLayoutTakeawayWidget({Key key,this.con, this.tabTab}) : super(key: key);
  @override
...
class _OrderBoxLayoutTakeawayWidgetState extends StateMVC<OrderBoxLayoutTakeawayWidget> {
  ...
  Widget build(BuildContext context) {
    return widget.con.orderList.isEmpty? EmptyOrdersWidget()
        :Container(
      child: Scrollbar(
        isAlwaysShown: true,
                ...
                children:[
                  Div(
                      ...
                      child:Column(
                          ...
                          children:[
                            Wrap(
                              children: List.generate(widget.con.orderList.length, (index) {
                                return OrderBoxWidget(orderDetails: widget.con.orderList.elementAt(index), tabTab: widget.tabTab, con:widget.con, pageType: 'takeaway',);
                              }
                              ),
                            ),
                          ]
