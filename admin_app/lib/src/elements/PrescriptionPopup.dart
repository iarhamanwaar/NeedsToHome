...
class PrescriptionPopup extends StatefulWidget{
  ...
  String popType;
  OrderController con;
  PrescriptionPopup({Key key, this.orderDetails,this.popType, this.con}) : super(key: key);
  @override
                                    ...
                                    child: Padding(
                                      ...
                                      child:Column(
                                          ...
                                          children:[
                                            ...
                                            SizedBox(height: 15),
                                            widget.popType=='image'?Container(
                                              width: size.width,
                                              height: size.height > 670 ? size.height : size.height/2,
                                              child: GestureDetector(
                                                onTap: () {

                                                },
                                                child:Image(image:NetworkImage(widget.orderDetails.pImage),
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: 'Enter the Total Amount of the image',
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                widget.popType=='image'? FlatButton(
                                                  onPressed: () {
                                                   Navigator.pop(context);
                                                  },
                                                ...
                                                // ignore: deprecated_member_use
                                                  ...
                                                  onPressed: () {
                                                   // widget.con.updateOrderAmountStatus(widget.orderDetails.orderId,amount, widget.orderDetails );
                                                  },
                                                  padding: EdgeInsets.only(top:15,bottom:15,left:40,right:40),
                                                  color: Theme.of(context).colorScheme.secondary.withOpacity(1),
                                                  shape: StadiumBorder(),
