...
class AECategoryPopup extends StatefulWidget{
  HServiceController con;
  CategoryModel categoryDetails;
  String pageType;
  AECategoryPopup({Key key, this.con, this.categoryDetails, this.pageType}) : super(key: key);
  @override
  _AECategoryPopupState createState() => _AECategoryPopupState();
}

class _AECategoryPopupState extends StateMVC<AECategoryPopup> {

  @override
  // ignore: must_call_super
  void initState() {
    if (widget.pageType == 'edit') {
      widget.con.hcategoryData.uploadImage = 'no_change';
    }
  }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              widget.pageType == 'add' ? Text(S.of(context).add_category,
                  style: Theme
                      .of(context)
                      .textTheme
                      .headline4
                        ...
                        Padding(
                          ...
                          child: Container(
                              ...
                              child: TextFormField(
                                  ...
                                  autocorrect: true,
                                  initialValue: widget.categoryDetails
                                      .categoryName,
                                  onSaved: (input) =>
                                  widget.con.hcategoryData.categoryName = input,
                                  validator: (input) =>
                                  input.length < 1 ? S
                                      .of(context)
                                      .please_enter_your_category : null,
                            ...
                            widget.pageType == 'add' ? Container(
                              ...
                              child: GestureDetector(
                                ...
                                child: _image == null ? Image(
                                  image: NetworkImage(
                                      widget.categoryDetails.uploadImage),
                                  height: double.infinity,
                                  width: double.infinity,
                                  fit: BoxFit.fill,
                                ) : GetPlatform.isWeb?Image.network(_image.path):Image.file(_image),),
