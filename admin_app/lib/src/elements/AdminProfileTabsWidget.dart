...
class AdminProfileTabsWidget extends StatefulWidget {
  @override
  _AdminProfileTabsWidgetState createState() => _AdminProfileTabsWidgetState();
}

class _AdminProfileTabsWidgetState extends State<AdminProfileTabsWidget>
