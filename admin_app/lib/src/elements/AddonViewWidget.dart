...
class AddonViewWidget extends StatefulWidget {
  ...
  String qty;
  AddonViewWidget({Key key, this.addonData, this.qty}) : super(key: key);
  @override
                  ...
                  children:[
                    ...
                    Expanded(
                      child:Container(
                        ...
                        child: Text('${widget.addonData.name} x ${widget.qty}(${Helper.pricePrint(widget.addonData.price)})',
                          overflow: TextOverflow.ellipsis,
                          maxLines: 1,
                        ),
                      ),
                    ),
                    Text(Helper.pricePrint(double.parse(widget.addonData.price)*double.parse(widget.qty)),
                        style: Theme
                            .of(context)
                            .textTheme
                            .bodyText2
