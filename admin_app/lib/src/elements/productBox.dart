                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ProductSettingHelper.exit(
                            context, widget.con, widget.choice, widget.shopType);
                      },
                    ),
                  ],
                ),
...
class ProductSettingHelper {
  static exit(context, con, product, shopType) => showDialog(
      context: context,
      builder: (context) => ProductPopup(con: con, product: product,shopType:shopType));
}
