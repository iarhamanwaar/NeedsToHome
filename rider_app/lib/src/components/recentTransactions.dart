          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
               ...
               widget.PageType=='full'? Text(S.of(context).transaction_details, style: Theme.of(context).textTheme.headline3):  Text(S.of(context).recent_trancations, style: Theme.of(context).textTheme.headline3),
