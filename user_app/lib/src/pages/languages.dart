    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: Theme.of(context).textTheme.headline3.merge(TextStyle( color:Theme.of(context).colorScheme.background)),
        ),
        actions: <Widget>[
          new ShoppingCartButtonWidget(iconColor: Theme.of(context).colorScheme.background.withOpacity(0.8), labelColor:Theme.of(context).colorScheme.primary),
        ],
      ),
