...
class VerticalPageTabs extends StatefulWidget {
  ...
  @override
  _VerticalPageTabsState createState() => _VerticalPageTabsState();
}
...
class _VerticalPageTabsState extends State<VerticalPageTabs>
  ...
  void initState() {
    ...
    widget.controllerScroll.addListener(_scrollListener);
  }
  _scrollListener() {

    if (widget.controllerScroll.offset >= widget.controllerScroll.position.maxScrollExtent &&
        !widget.controllerScroll.position.outOfRange) {

      setState(() {
        tabState = _selectedIndex+1;
       print('page bottom${_selectedIndex}');
      });
      pageController.jumpToPage(tabState);
    }
    if (widget.controllerScroll.offset-50 <= widget.controllerScroll.position.minScrollExtent &&
        !widget.controllerScroll.position.outOfRange) {
      setState(() {
        tabState = _selectedIndex -1;
        print('page top${tabState}');
      });
      pageController.jumpToPage(tabState);
    }
  }
