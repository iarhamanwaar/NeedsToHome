          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
               ...
               widget.PageType=='full'? Text(S.of(context).transaction_history, style: Theme.of(context).textTheme.headline3):  Text(S.of(context).transaction_history, style: Theme.of(context).textTheme.headline3),

                GestureDetector(
              onTap: () {
                Navigator.of(context).pushNamed('/TransactionHistory');
              },child:  widget.PageType=='full'? Container() : Text(S.of(context).see_all,style: Theme.of(context).textTheme.headline3.merge(TextStyle(fontWeight: FontWeight.w400))),
            ),
              ],
            ),
          ),
              ...
              itemBuilder: (context, index){
               WalletTransactions _walletData =  _con.walletTransactionList.elementAt(index);
                return
                  ...
                  title: _walletData.type=='credit'?S.of(context).credit:S.of(context).debited,
                  subTitle: _walletData.type=='credit'?S.of(context).your_amount_is_credited:S.of(context).your_amount_is_debited,
