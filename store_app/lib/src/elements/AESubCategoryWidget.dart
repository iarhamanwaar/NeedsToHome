...
class AddSubCategoryPopup extends StatefulWidget {
  ...
  Function setState;
  AddSubCategoryPopup(
      {Key key, this.con, this.categoryDetails, this.pageType, this.setState})
      : super(key: key);
  @override
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 20),
              widget.pageType == 'add'
                  ? Text(S.of(context).add_subcategory,
                      style: Theme.of(context).textTheme.headline4)
                  : Text(S.of(context).edit_subcategory,
                      style: Theme.of(context).textTheme.headline4),
              Form(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                              ...
                              child: TextFormField(
                                  ...
                                  autocorrect: true,
                                  initialValue:
                                      widget.categoryDetails.subcategoryName,
                                  onSaved: (input) => widget.con.subcategoryData
                                      .subcategoryName = input,
                                  validator: (input) => input.length < 1
                                      ? S
                                          .of(context)
                                          .please_enter_your_subcategory
                                      : null,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            FlatButton(
                              onPressed: () {
                                widget.con.addEditSubCategory(widget.pageType,
