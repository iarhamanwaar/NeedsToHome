...
class _ManualDriverPopupState extends StateMVC<ManualDriverPopup> {
  ...
  void initState() {
    ...
    if(currentUser.value.driverAllAccess==true) {
      listenForDropdown('manual', 1, widget.orderId, widget.orderDetails, context);
    }else {
      listenForDropdown('manual', 0, widget.orderId, widget.orderDetails, context);
    }
  }
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                                children: [
                                  ...
                                  Text(S.of(context).assign_your_driver,
                                      style: Theme.of(context).textTheme.headline4
                                  ),
                                  Text(S.of(context).your_nearest_driver,
                                          ...
                                          children:[
                                            ...
                                            Padding(
                                              ...
                                              child:Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text(S.of(context).select_your_driver,
  ...
  Future<void> listenForDropdown(type, driverState, orderID, orderDetailsData, context) async {
    dropDownList.clear();
    final Stream<DropDownModel> stream = await getDriverData(type, driverState, orderID);
