...
import 'ProfileProcessCheckingWidget.dart';
import 'SettingPopUpWidget.dart';
      ...
      setState(() {
        ...
        if(type=='open') {
          if(setting.value.mobileLanguage.value.languageCode=='en') {
            ...
            _con.basicInformationData.openingTime  = Helper.tConvert(picked.hour, picked.minute.toString());
          ...
          closetime.text = picked.format(context);
            ...
            _con.basicInformationData.closingTime= Helper.tConvert(picked.hour, picked.minute.toString());
    ...
    return ClipRRect(
        ...
        child: Container(
          ...
          child: Container(
              ...
              child: state?ProfileProcessChecking(  onCLick: () {
                setState(() {
                  state = false;
                });
              },):
                ...
                Container(
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      ...
                      Tab(
                          child: Container(
                            child: Text(S.of(context).basic_information,
                      ...
                      Tab(
                          child: Container(
                            child: Text(S.of(context).seller_kyc,
                                style: TextStyle(fontWeight: FontWeight.w600)),
                          )),
                      Tab(
                          child: Container(
                            child: Text(S.of(context).settings_and_agreement,
                                style: TextStyle(fontWeight: FontWeight.w600)),
                          )),
                                                        ...
                                                        children:[
                                                          Container(
                                                            ...
                                                            child:Text(
                                                              ...
                                                              style:MediaQuery.of(context).size.width > 769 ? Theme.of(context).textTheme.headline4 : Theme.of(context).textTheme.headline1,
                                                            ),),
                                                          Container(
                                                            margin: EdgeInsets.only(left: MediaQuery.of(context).size.width > 769 ? 20 : 10, right: MediaQuery.of(context).size.width > 769 ? 30 : 0, bottom: 20),
                                                            child: Wrap(
                                                                runSpacing: 10,
                                                                children: [
                                                                  Container(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    child: TextFormField(
                                                                                        ...
                                                                                        validator: (input) => input.length < 1 ? S.of(context).please_enter_the_legal_name : null,
                                                                                        keyboardType: TextInputType.text,
                                                                                        decoration: InputDecoration(
                                                                                          labelText: S.of(context).company_legal_name,
                                                                                          labelStyle: Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                                          suffixIcon: Tooltip(message: "Your legal name which mentioned in Bill or in Address Proof.", child: Icon(Icons.help, color: Colors.grey)),
                                                                                          enabledBorder: UnderlineInputBorder(
                                                                                            borderSide: BorderSide(
                                                                                              color: Colors.grey,
                                                                                              width: 1.0,
                                                                                  ...
                                                                                  Container(
                                                                                      ...
                                                                                      child: TextFormField(
                                                                                          ...
                                                                                          validator: (input) => input.length < 1 ? S.of(context).mobile : null,
                                                                                          keyboardType: TextInputType.number,
                                                                                          decoration: InputDecoration(
                                                                                  ...
                                                                                  Container(
                                                                                      ...
                                                                                      child: TextFormField(
                                                                                          ...
                                                                                          validator: (input) => input.length < 1 ?  S.of(context).please_enter_the_alter_mobile : null,
                                                                                          keyboardType: TextInputType.number,
                                                                                          decoration: InputDecoration(
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    MediaQuery.of(context).size.width * 0.3 :double.infinity,
                                                                                    child: Text('${S.of(context).enter_the_mail_id_for_order_notifications__newsletters_and_offers_from} ${setting.value.appName}'),
                                                                                  ),
                                                                                ...
                                                                                children:[
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    child: TextFormField(
                                                                                        ...
                                                                                        decoration: InputDecoration(
                                                                                          ...
                                                                                          labelStyle: Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                                          suffixIcon: Tooltip(message: "Your store name in ${setting.value.appName} .For Example : XYZ Textiles(Note : Name displayed as Store name in ${setting.value.appName})", child: Icon(Icons.help, color: Colors.grey)),
                                                                                          enabledBorder: UnderlineInputBorder(
                                                                                            borderSide: BorderSide(
                                                                                              color: Colors.grey,
                                                                                              width: 1.0,
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    child: TextFormField(
                                                                                        ...
                                                                                        validator: (input) => input.length < 1 ?  S.of(context).please_enter_the_subtitle_of_the_store : null,
                                                                                        keyboardType: TextInputType.text,
                                                                                        decoration: InputDecoration(
                                                                                      ...
                                                                                      children: [
                                                                                        Wrap(
                                                                                          ...
                                                                                          children: [
                                                                                            ...
                                                                                            Padding(
                                                                                              padding: EdgeInsets.only(top: MediaQuery.of(context).size.width > 769 ? 5 : 15),
                                                                                              child: Text(
                                                                                  ...
                                                                                  Container(
                                                                                    width: double.infinity,
                                                                                    margin: EdgeInsets.only(top: MediaQuery.of(context).size.width > 769 ? 25 : 0,),
                                                                                    child: Column(
                                                                                      children: [
                                                                                        Text(
                                                                                        ...
                                                                                        SizedBox(height: 10,),
                                                                                        Container(
                                                                                          margin: EdgeInsets.only(top: MediaQuery.of(context).size.width > 769 ? 20: 10,
                                                                                              left: MediaQuery.of(context).size.width > 769 ? 20: 10,right:MediaQuery.of(context).size.width > 769 ? 0: 10
                                                                                          ),
                                                                                          width: MediaQuery.of(context).size.width > 769 ? MediaQuery.of(context).size.width * 0.12 : double.infinity,
                                                                                          height: MediaQuery.of(context).size.width > 769 ? MediaQuery.of(context).size.width * 0.1 : 200,
                                                                                          child:GestureDetector(
                                                                                            onTap: () {
                                                                                              imagePickerBottomsheet('logo');
                                                                                            },
                                                                  ...
                                                                  MediaQuery.of(context).size.width > 769 ? Div(
                                                                      colS:12,
                                                                      colM:12,
                                                                      colL:2,
                                                                      child:Column(
                                                                        children:[
                                                                      Container(
                                                                      padding: EdgeInsets.only(left:0,top:MediaQuery.of(context).size.width > 769 ?  0 : 20),
                                                                      width:double.infinity,
                                                                      height:MediaQuery.of(context).size.width > 769 ? MediaQuery.of(context).size.height * 0.5 : 200,
                                                                      child:Image(image:AssetImage('assets/img/loader.gif'),
                                                                        height: double.infinity,
                                                                        width:double.infinity,
                                                                        fit: BoxFit.fitHeight,
                                                                          ...
                                                                          Container(
                                                                              child:Text(S.of(context).your_currently_registered_shop,style:TextStyle(color:Colors.green,fontSize:10))
                                                                          ),
                                                                          Row(
                                                                              mainAxisAlignment:MainAxisAlignment.center,
                                                                              children:[
                                                                                Text(currentUser.value.focusName,style:TextStyle(color:Colors.green,fontSize:10,fontWeight:FontWeight.bold))
                                                                              ]
                                                                          ),
                                                                          SizedBox(height:30),
                                                                          MaterialButton(
                                                          ...
                                                          Container(
                                                            margin: EdgeInsets.only(top: MediaQuery.of(context).size.width > 769 ? 20 : 0, left: MediaQuery.of(context).size.width > 769 ? 20 : 10, right:MediaQuery.of(context).size.width > 769? 20 : 10),
                                                            child: Text(
                                                          ...
                                                          Container(
                                                            margin: EdgeInsets.only(left: MediaQuery.of(context).size.width > 769 ? 20 : 10, right: MediaQuery.of(context).size.width > 769 ? 30 : 0, bottom: MediaQuery.of(context).size.width > 769 ? 20 :0),
                                                            child: Wrap(
                                                                runSpacing: 10,
                                                                children: [
                                                                  Container(
                                                                      child: Div(
                                                                          ...
                                                                          child:Container(
                                                                            ...
                                                                            child: Column(
                                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                                children: [
                                                                                  Text(S.of(context).select_your_zone,style:Theme.of(context).textTheme.subtitle1),
                                                                                  Container(
                                                                                    width: double.infinity,
                                                                                    child: DropdownButtonFormField(
                                                                                        ...
                                                                                        isExpanded: true,
                                                                                        validator: (value) =>
                                                                                        value == null ? S.of(context).please_select : null,
                                                          ...
                                                          GetPlatform.isWeb || GetPlatform.isMobile ? Container(
                                                            margin: EdgeInsets.only(left: MediaQuery.of(context).size.width > 769 ? 20 : 10, right: MediaQuery.of(context).size.width > 769 ? 30 : 0, bottom: MediaQuery.of(context).size.width > 769 ? 20 :0),
                                                            child: Wrap(
                                                                runSpacing: 10,
                                                                children: [
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    child: TextFormField(
                                                                                        textAlign: TextAlign.left,
                                                                                        autocorrect: true,
                                                                                        validator: (input) => input.length < 1 ? S.of(context).enter_your_name : null,
                                                                                        ...
                                                                                        decoration: InputDecoration(
                                                                                          ...
                                                                                          labelStyle: Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                                          suffixIcon: Tooltip(message: "Give us the Name of the Owner or Managing Director or Admin of your company.", child: Icon(Icons.help, color: Colors.grey)),
                                                                                          enabledBorder: UnderlineInputBorder(
                                                                                            borderSide: BorderSide(
                                                                                              color: Colors.grey,
                                                                                              width: 1.0,
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    child: TextFormField(
                                                                                        ...
                                                                                        validator: (input) => input.length < 1 ? S.of(context).please_enter_latitude : null,
                                                                                     ...
                                                                                     /*   inputFormatters: [
                                                                                        ...
                                                                                        decoration: InputDecoration(
                                                                                          ...
                                                                                          labelStyle: Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                                          suffixIcon: Tooltip(message: "Enter Your latitude", child: IconButton(
                                                                                            icon: Icon(Icons.location_on),
                                                                                            onPressed: () {
                                                                                              // do something
                                                                                              launch('https://www.latlong.net/convert-address-to-lat-long.html');
                                                                                            },
                                                                                          ),),
                                                                                          enabledBorder: UnderlineInputBorder(
                                                                                            borderSide: BorderSide(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Container(
                                                                                      ...
                                                                                      child: TextFormField(
                                                                                          ...
                                                                                          validator: (input) => input.length < 1 ? S.of(context).please_enter_the_pickUp_address : null,
                                                                                          keyboardType: TextInputType.text,
                                                                                          decoration: InputDecoration(
                                                                                            labelText: S.of(context).address,
                                                                                            labelStyle: Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                                            suffixIcon: Tooltip(message: "Give us the exact address for Pickup/Dispatch of your Product for Shipping", child: Icon(Icons.help, color: Colors.grey)),
                                                                                            enabledBorder: UnderlineInputBorder(
                                                                                              borderSide: BorderSide(
                                                                                                color: Colors.grey,
                                                                                                width: 1.0,
                                                                                    ...
                                                                                    Container(
                                                                                      child: TextFormField(
                                                                                          ...
                                                                                          validator: (input) => input.length < 1 ? S.of(context).please_enter_your_landmark : null,
                                                                                          keyboardType: TextInputType.text,
                                                                                          decoration: InputDecoration(
                                                                                      ...
                                                                                      child: TextFormField(
                                                                                         ...
                                                                                         /* inputFormatters: [
                                                                                          ...
                                                                                          decoration: InputDecoration(
                                                                                            ...
                                                                                            labelStyle: Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                                            suffixIcon: Tooltip(message: "Enter Your longitude", child: IconButton(
                                                                                              icon: Icon(Icons.location_on),
                                                                                              onPressed: () {
                                                                                                // do something
                                                                                                launch('https://www.latlong.net/convert-address-to-lat-long.html');
                                                          ...
                                                          Container(
                                                            margin: EdgeInsets.only(
                                                                top: MediaQuery.of(context).size.width > 769 ? 20 :0, left:MediaQuery.of(context).size.width > 769 ? 20 : 10,
                                                                ...
                                                                children: [
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    child: TextFormField(
                                                                                      ...
                                                                                      validator: (input) => input.length < 1 ? S.of(context).opening_time : null,
                                                                                      decoration: InputDecoration(
                                                                                          prefixIcon: Icon(Icons.timer),
                                                                                          suffixIcon: Tooltip(message: "Provide the details of your Store opening time (HH : MM AM or PM )", child: Icon(Icons.help, color: Colors.grey)),
                                                                                          //icon of text field
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    child: TextFormField(
                                                                                      ...
                                                                                      validator: (input) => input.length < 1 ? S.of(context).closing_time : null,
                                                                                      decoration: InputDecoration(
                                                                                          suffixIcon: Tooltip(message: "Provide the details of your Store Closing time (HH : MM AM or PM )", child: Icon(Icons.help, color: Colors.grey)),
                                                                                          prefixIcon: Icon(Icons.timer),
                                                                                          //icon of text field
                                                                                          labelText: S.of(context).enter_time //label text of field
                                                                                      ),
                                                                  ...
                                                                  Container(
                                                                      child: Div(
                                                                          ...
                                                                          colL: 6,
                                                                          child: Container(
                                                                              padding:EdgeInsets.only(left:MediaQuery.of(context).size.width > 769 ? 20 :0 ,top:30),
                                                                              child: Column(
                                                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                                                  children: [
                                                                                    Padding(
                                                                                    ...
                                                                                    Container(
                                                                                      ...
                                                                                      child: TextFormField(
                                                                                          ...
                                                                                          onSaved:(input) =>  _con.basicInformationData.handOverTime = input,
                                                                                          keyboardType: TextInputType.numberWithOptions(decimal: true),
                                                                                          validator: (input) => input.length < 1 ? 'please your handover time' : null,
                                                                                          ...
                                                                                          decoration: InputDecoration(
                                                                                            labelText: S.of(context).handover_time,
                                                                                            labelStyle: Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                                            // suffixIcon: Tooltip(message: "Enter Your Store Name", child: Icon(Icons.help, color: Colors.grey)),
                                                                                            enabledBorder: UnderlineInputBorder(
                                                                                              borderSide: BorderSide(
                                                              ...
                                                              children: [
                                                                ...
                                                                Container(
                                                                    ...
                                                                    child: TextFormField(
                                                                        ...
                                                                        validator: (input) => input.length < 1 ? S.of(context).please_enter_the_personal_proof : null,
                                                                        keyboardType: TextInputType
                                                                            .number,
                                                                        decoration: InputDecoration(
                                                                          suffixIcon: Tooltip(message: "Any (GOV) proof id", child: Icon(Icons.help, color: Colors.grey)),
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child:Container(
                                                                    ...
                                                                    child: DropdownButtonFormField(
                                                                        ...
                                                                        items: [
                                                                          DropdownMenuItem(
                                                                            child: Text(S.of(context).private_limited_company),
                                                                            value: 'Private Limited Company',
                                                                          ),
                                                                          DropdownMenuItem(
                                                                            child: Text(S.of(context).limited_liablility_partership),
                                                                            value: 'Limited Liability Partnership',
                                                                          ),
                                                                          DropdownMenuItem(child: Text(S.of(context).partnership), value: 'Partnership'),
                                                                          DropdownMenuItem(child: Text(S.of(context).sole_proprietorship), value: 'Sole Proprietorship'),
                                                                          DropdownMenuItem(child: Text(S.of(context).one_person_company), value: 'One Person Company'),
                                                                          DropdownMenuItem(child: Text(S.of(context).startup), value: 'Startup'),
                                                                          DropdownMenuItem(child: Text(S.of(context).other), value: 'Other'),
                                                                        ],
                                                                        onChanged: (value) {
                                                                          setState(() {
                                                                            _type = value;
                                                              ...
                                                              children: [
                                                                Container(
                                                                    ...
                                                                    child: TextFormField(
                                                                        textAlign: TextAlign.left,
                                                                        autocorrect: true,
                                                                        validator: (input) => input.length < 1 ? S.of(context).please_enter_the_started_year : null,
                                                                        keyboardType: TextInputType.number,
                                                                        ...
                                                                        decoration: InputDecoration(
                                                                          ...
                                                                          suffixIcon: Tooltip(message: "Enter the company started year", child: Icon(Icons.help, color: Colors.grey)),
                                                                          enabledBorder:
                                                              ...
                                                              children: [
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child:Container(
                                                                    width: double.infinity,
                                                                    child: DropdownButtonFormField(
                                                                        value: _con.sellerKycData.proofType,
                                                                        isExpanded: true,
                                                                        ...
                                                                        onChanged: (value) {
                                                                          setState(() {
                                                                            ...
                                                                            _con.sellerKycData.proofType = value;
                                                                          });
                                                                        }
                                                                    ),
                                                                  ),
                                                                  ...
                                                                  child: Column(
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:GestureDetector(
                                                                          onTap: () {
                                                                            imagePickerBottomsheet('proof');
                                                                          },
                                                                          child: _image2 == null?Image(image:AssetImage('assets/img/category_15.jpg'),
                                                                            height: double.infinity,
                                                                            width:double.infinity,
                                                                            fit: BoxFit.fill,
                                                              ...
                                                              children: [
                                                                Container(
                                                                    ...
                                                                    TextFormField(
                                                                        ...
                                                                        validator: (input) => input.length < 1 ? S.of(context).please_enter_the_holders_name : null,
                                                                        keyboardType: TextInputType
                                                                            .text,
                                                                        ...
                                                                        decoration: InputDecoration(
                                                                          ...
                                                                          labelStyle: Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                          suffixIcon: Tooltip(message: "Please enter the Holders name", child: Icon(Icons.help, color: Colors.grey)),
                                                                          enabledBorder: UnderlineInputBorder(
                                                                            borderSide: BorderSide(
                                                                              color: Colors.grey,
                                                                              width: 1.0,
                                                                ...
                                                                Container(
                                                                    ...
                                                                    TextFormField(
                                                                        ...
                                                                        keyboardType: TextInputType
                                                                            .text,
                                                                        validator: (input) => input.length < 1 ? S.of(context).please_enter_the_branch : null,
                                                                        onSaved: (input) => _con.sellerKycData.branch = input,
                                                                        decoration: InputDecoration(
                                                                          labelText: S.of(context).branch,
                                                                          labelStyle: Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                          suffixIcon: Tooltip(message: "Please enter the Branch", child: Icon(Icons.help, color: Colors.grey)),
                                                                          enabledBorder: UnderlineInputBorder(
                                                                            borderSide: BorderSide(
                                                                              color: Colors.grey,
                                                                              width: 1.0,
                                                              ...
                                                              children: [
                                                                Container(
                                                                    ...
                                                                    child: TextFormField(
                                                                        ...
                                                                        validator: (input) => input.length < 1 ? S.of(context).please_enter_the_account_number : null,
                                                                        ...
                                                                        decoration: InputDecoration(
                                                                          ...
                                                                          labelStyle:
                                                                          Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                          suffixIcon: Tooltip(message: "Please enter the Account Number", child: Icon(Icons.help, color: Colors.grey)),
                                                                          enabledBorder:
                                                                          UnderlineInputBorder(
                                                                            borderSide: BorderSide(
                                                                              color: Colors.grey,
                                                                ...
                                                                Container(
                                                                    ...
                                                                    child: TextFormField(
                                                                        ...
                                                                        autocorrect: true,
                                                                        validator: (input) => input.length < 1 ? S.of(context).please_enter_bank_code : null,
                                                                        keyboardType: TextInputType.text,
                                                                        onSaved: (input) => _con.sellerKycData.bankCode = input,
                                                                        decoration: InputDecoration(
                                                                          labelText:
                                                                          S.of(context).bank_code,
                                                                          labelStyle:
                                                                          Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: Colors.grey)),
                                                                          enabledBorder:
                                                                          UnderlineInputBorder(
                                                                ...
                                                                Container(
                                                                    ...
                                                                    TextFormField(
                                                                        ...
                                                                        validator: (input) => input.length < 1 ? S.of(context).please_enter_bank_name : null,
                                                                        keyboardType: TextInputType
                                                                            .text,
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  child: Center(
                                    child: (_tabController.index !=3)?TextButton(
                                        onPressed: () {
            ...
            child: new Column(
              ...
              children: [
                new ListTile(
                  ...
                  onTap: () => type=='logo'?getImage():getImageProof(),
                ),
                new ListTile(
                  leading: new Icon(Icons.image),
                  title: new Text(S.of(context).gallery),
                  onTap: () => type=='logo'?getImagegaller():getImageGalleryProof(),
                ),
              ],
            ),
          );
    ...
    if (GetPlatform.isWeb || GetPlatform.isMobile) {
      ...
      setState(() {
        if (pickedFile != null) {
          ...
          _con.sellerKycData.proof  = pickedFile;
          Navigator.of(context).pop();
        } else {
          print('No image selected.');
        }
      ...
      setState(() {
        ...
        _con.sellerKycData.proof  = _image2;
      });
