...
class ForgotPassword extends StatefulWidget {
  ...
  UserController con;
  ForgotPassword(
      {@required this.onOTPSelected, this.onLogInSelected, this.con});
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            if (widget.con.loginFormKey.currentState
                                .validate()) {
                              ...
                              String code =
                                  (rng.nextInt(9000) + 1000).toString();
                              print('code');
                              print(code);
