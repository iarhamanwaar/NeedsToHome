...
Future<Setting> initSettings() async {
  ...
  Setting _setting;
  final String url = '${GlobalConfiguration().getValue('api_base_url')}Api_provider/settings/$userId';
  print(url);
  try {
    ...
    if (response.statusCode == 200 && response.headers.containsValue('application/json')) {
      ...
      if (json.decode(response.body)['data'] != null) {
        ...
        print('setting loades');
        print(setting.value.defaultCurrency);
        print(setting.value.currencyRight);
