...
class VerticalTabs extends StatefulWidget {
  ...
  VerticalTabs(
      ...
      this.selectedTabBackgroundColor = const Color(0xfff8f8f8),
      this.tabBackgroundColor = const Color(0xFF5dc650),
      this.selectedTabTextStyle = const TextStyle(color: Colors.green),
      this.tabTextStyle = const TextStyle(color: Colors.green),
      this.changePageCurve = Curves.easeInOut,
      this.changePageDuration = const Duration(milliseconds: 200),
