...
import 'package:handy/src/components/light_color.dart';
import 'package:handy/src/components/title_text.dart';
...
class _TopUpPageState extends StateMVC<TopUpPage> {
  ...
  Widget _transferButton() {
    return InkWell(
      onTap: (){
        if(_con.walletData.balance!='0') {

          if(double.parse(_con.walletData.balance)>double.parse(textEditingController.text)) {
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: TextFormField(
                         ...
                         onChanged: (input) => _con.rechargeData.amount = input,
